...
Presenter: Dr. Prince Kumar Lat
Host Institute: School of Biosciences and Bioengineering (SBB), IIT Mandi
...
•	Interactive practice session: small coding challenges (e.g., DNA base counting, GC content)
________________________________________

2. Introduction to Bioinformatics with Biopython (≈45 min)
•	Overview of Biopython and biological data structures
•	Reading and parsing sequence files (FASTA, GenBank)
•	Working with Seq and SeqRecord objects
•	Fetching data from NCBI and sequence manipulation
•	Hands-on exercises: translating sequences, reverse complements, sequence statistics
________________________________________
3. Data Handling and Visualization (≈45 min)
•	Introduction to Pandas DataFrames for biological datasets
•	Importing and cleaning biological data (CSV/FASTA metadata)
•	Basic statistics and data summaries
•	Plotting with Matplotlib and Seaborn
•	Interactive demo: visualize gene expression or protein property data
________________________________________
4. Introduction to RDKit for Cheminformatics (≈45 min)
•	Basics of molecular representations (SMILES, SDF)
•	Creating molecule objects and computing properties
•	Visualization of chemical structures
•	Calculating molecular fingerprints and similarity
•	Practice: identify most similar compounds in a small dataset
________________________________________
5. Mini Project – Integrative Application (≈45 min)
•	Combining Python, Biopython, Pandas, and RDKit
•	Example project: Analyzing a small compound or gene dataset
o	Parse sequences with Biopython
o	Organize data using Pandas
o	Visualize trends
o	Add a chemical structure component with RDKit
...
•	Handle and visualize real-world datasets using Pandas and Matplotlib
•	Perform basic cheminformatics tasks using RDKit
